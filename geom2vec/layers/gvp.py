...
class GVPConv(MessagePassing):
    ...
    def message(self, s_i, v_i, s_j, v_j):
        ...
        message = tuple_cat((s_j, v_j), (s_i, v_i))
...
class GVPConvLayer(nn.Module):
    ...
    def __init__(self, node_dims,
        ...
        self.conv = GVPConv(node_dims, node_dims, n_message,
    ...
    def forward(self, x, edge_index,
        ...
        if autoregressive_x is not None:
            ...
            dh = tuple_sum(
                self.conv(x, edge_index_forward),
